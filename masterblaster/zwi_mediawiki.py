...
parser.add_argument("-s", '--source', help="Source of the article")
...
if source == 'wikipedia':
    ...
    SITE="Wikisource";  # Full title of the Wiki
    SITE_API="https://en.wikisource.org/w/"; # Should Points to api.php
    endPoint = SITE_API+"api.php";
    SITE_URL="https://en.wikisource.org/wiki/"; # Where all articles are located (SITE_URL+title)
    SITE_SHORT="wikisource";                    # short name
elif source == 'handwiki':
    SITE="HandWiki";  # Full title of the Wiki
    SITE_API="https://handwiki.org/wiki/"; # Should Points to api.php
    endPoint = SITE_API+"api.php";
    SITE_URL="https://handwiki.org/wiki/"; # Where all articles are located (SITE_URL+title)
    SITE_SHORT="handwiki";                    # short name
elif source == 'citizendium':
    SITE="Citizendium";  # Full title of the Wiki
    SITE_API="https://citizendium.org/wiki/"; # Should Points to api.php
    endPoint = SITE_API+"api.php";
    SITE_URL="https://citizendium.org/wiki/"; # Where all articles are located (SITE_URL+title)
    SITE_SHORT="citizendium";                    # short name
...
zwi_file=source+"-"+title+".zwi"
zwi_file=zwi_file.replace(" ", "_")
zwi_file=urllib.parse.quote(zwi_file, safe='')
